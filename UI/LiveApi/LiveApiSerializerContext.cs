...
namespace Mesen.LiveApi
{
	...
	[JsonSerializable(typeof(LiveApiCheatSearchInitRequest))]
	[JsonSerializable(typeof(LiveApiCheatSearchFilterRequest))]
	[JsonSerializable(typeof(LiveApiCheatSearchSnapshotRequest))]
	[JsonSerializable(typeof(LiveApiCheatSearchSnapshotInfo))]
	[JsonSerializable(typeof(LiveApiCheatSearchSnapshotInfo[]))]
	[JsonSerializable(typeof(LiveApiCheatSearchResult))]
	[JsonSerializable(typeof(LiveApiCheatSearchResult[]))]
	[JsonSerializable(typeof(LiveApiCheatSearchState))]
